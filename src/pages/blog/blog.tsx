...
export default function Blog() {
  ...
  return (
    <>
      <SeoHead
        title="Blog"
        description="개발 여정에서 배운 것들을 기록하고 공유하는 블로그입니다."
        path="/blog"
        jsonLd={{
      ...
      <main id="main-content" className={s.container}>
        ...
        <section className={s.page}>
          <motion.div
            ...
            animate={
              pageReady ? { opacity: 1, scale: 1, filter: "blur(0px)" } : undefined
            }
          ...
          >
            <div>
              <motion.img
                ...
                animate={pageReady ? { opacity: 1, y: 0, rotate: -30 } : undefined}
            ...
            >
              A space to record my{" "}
              <img src="/icon/air-balloon.png" alt="" aria-hidden="true" /> journey,
              <br /> <img src="/icon/pencil.png" alt="" aria-hidden="true" />
              learn, and <img src="/icon/pacman.png" alt="" aria-hidden="true" /> share
            </motion.h1>
